            ...
            <form @submit.prevent="submitForm">
              ...
              <div class="form-group" style="margin-bottom: 25px;">
                ...
                <textarea 
                  ...
                  placeholder="Describe the event... e.g., In line with efforts to advance internationalization and support the achievement of the Sustainable Development Goals (SDGs)..."
                ></textarea>
